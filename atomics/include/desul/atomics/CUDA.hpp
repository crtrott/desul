...
#define DESUL_IMPL_CUDA_HOST_ATOMIC_ADD(TYPE, ORDER, SCOPE)   \
  inline void device_atomic_add(                              \
      TYPE* const dest, TYPE val, ORDER order, SCOPE scope) { \
...
#define DESUL_IMPL_CUDA_HOST_ATOMIC_INC(TYPE, ORDER, SCOPE)                   \
  inline void device_atomic_inc(TYPE* const dest, ORDER order, SCOPE scope) { \
...
#define DESUL_IMPL_CUDA_HOST_ATOMIC_DEC(TYPE, ORDER, SCOPE)                   \
  inline void device_atomic_dec(TYPE* const dest, ORDER order, SCOPE scope) { \
...
#define DESUL_IMPL_CUDA_HOST_ATOMIC_INC_MOD(TYPE, ORDER, SCOPE)                    \
  inline TYPE device_atomic_fetch_inc_mod(                                         \
      TYPE* dest, TYPE val, ORDER order, SCOPE scope) {                            \
...
#define DESUL_IMPL_CUDA_HOST_ATOMIC_DEC_MOD(TYPE, ORDER, SCOPE)                    \
  inline TYPE device_atomic_fetch_dec_mod(                                         \
      TYPE* dest, TYPE val, ORDER order, SCOPE scope) {                            \
    using cas_t = typename Impl::atomic_compare_exchange_type<sizeof(TYPE)>::type; \
    cas_t oldval = reinterpret_cast<cas_t&>(*dest);                                \
    cas_t assume = oldval;                                                         \
...
#define DESUL_IMPL_CUDA_HOST_ATOMIC_FETCH_ADD(TYPE, ORDER, SCOPE)    \
  inline TYPE device_atomic_fetch_add(                               \
      TYPE* const dest, TYPE val, ORDER order, SCOPE scope) {        \
...
#define DESUL_IMPL_CUDA_HOST_ATOMIC_FETCH_SUB(TYPE, ORDER, SCOPE)    \
  inline TYPE device_atomic_fetch_sub(                               \
      TYPE* const dest, TYPE val, ORDER order, SCOPE scope) {        \
    return Impl::atomic_fetch_oper(                                  \
...
#define DESUL_IMPL_CUDA_HOST_ATOMIC_FETCH_MAX(TYPE, ORDER, SCOPE)    \
  inline TYPE device_atomic_fetch_max(                               \
      TYPE* const dest, TYPE val, ORDER order, SCOPE scope) {        \
    return Impl::atomic_fetch_oper(                                  \
...
#define DESUL_IMPL_CUDA_HOST_ATOMIC_FETCH_MIN(TYPE, ORDER, SCOPE)    \
  inline TYPE device_atomic_fetch_min(                               \
      TYPE* const dest, TYPE val, ORDER order, SCOPE scope) {        \
    return Impl::atomic_fetch_oper(                                  \
...
DESUL_IMPL_CUDA_HOST_ATOMIC_FETCH_MIN(unsigned long,
                                      ...
                                      MemoryScopeDevice);
//  DESUL_IMPL_CUDA_HOST_ATOMIC_FETCH_MIN(unsigned long
//  long,MemoryOrderRelaxed,MemoryScopeDevice); inline void
//  device_atomic_fetch_max(int32_t* const dest, int32_t val, MemoryOrderRelaxed order,
...
namespace desul {
__device__ inline unsigned long long device_atomic_fetch_add(
    unsigned long long* const dest,
...
__device__ inline long long device_atomic_fetch_add(long long* const dest,
                                                    long long val,
                                                    MemoryOrderRelaxed order,
                                                    MemoryScopeDevice scope) {
  return Impl::atomic_fetch_oper(
...
__device__ inline long device_atomic_fetch_add(long* const dest,
                                               long val,
                                               MemoryOrderRelaxed order,
                                               MemoryScopeDevice scope) {
  return Impl::atomic_fetch_oper(
...
__device__ inline long long device_atomic_fetch_sub(long long* const dest,
                                                    long long val,
                                                    MemoryOrderRelaxed order,
                                                    MemoryScopeDevice scope) {
  return Impl::atomic_fetch_oper(
...
__device__ inline long device_atomic_fetch_sub(long* const dest,
                                               long val,
                                               MemoryOrderRelaxed order,
                                               MemoryScopeDevice scope) {
  return Impl::atomic_fetch_oper(
...
__device__ inline long device_atomic_fetch_max(long* const dest,
                                               long val,
                                               MemoryOrderRelaxed order,
                                               MemoryScopeDevice scope) {
  return Impl::atomic_fetch_oper(
...
__device__ inline long device_atomic_fetch_min(long* const dest,
                                               long val,
                                               MemoryOrderRelaxed order,
                                               MemoryScopeDevice scope) {
  return Impl::atomic_fetch_oper(
...
__device__ inline long device_atomic_fetch_or(long* const dest,
                                              long val,
                                              MemoryOrderRelaxed order,
                                              MemoryScopeDevice scope) {
  return Impl::atomic_fetch_oper(
...
__device__ inline long long device_atomic_fetch_or(long long* const dest,
                                                   long long val,
                                                   MemoryOrderRelaxed order,
                                                   MemoryScopeDevice scope) {
  return Impl::atomic_fetch_oper(
...
__device__ inline long device_atomic_fetch_xor(long* const dest,
                                               long val,
                                               MemoryOrderRelaxed order,
                                               MemoryScopeDevice scope) {
  return Impl::atomic_fetch_oper(
...
__device__ inline long long device_atomic_fetch_xor(long long* const dest,
                                                    long long val,
                                                    MemoryOrderRelaxed order,
                                                    MemoryScopeDevice scope) {
  return Impl::atomic_fetch_oper(
...
__device__ inline long device_atomic_fetch_and(long* const dest,
                                               long val,
                                               MemoryOrderRelaxed order,
                                               MemoryScopeDevice scope) {
  return Impl::atomic_fetch_oper(
...
__device__ inline long long device_atomic_fetch_and(long long* const dest,
                                                    long long val,
                                                    MemoryOrderRelaxed order,
                                                    MemoryScopeDevice scope) {
  return Impl::atomic_fetch_oper(
...
__device__ inline unsigned long long device_atomic_add_fetch(
    unsigned long long* const dest,
    unsigned long long val,
    MemoryOrderRelaxed order,
    MemoryScopeDevice scope) {
...
__device__ inline long long device_atomic_add_fetch(long long* const dest,
                                                    long long val,
                                                    MemoryOrderRelaxed order,
                                                    MemoryScopeDevice scope) {
  return Impl::atomic_oper_fetch(
...
__device__ inline long device_atomic_add_fetch(long* const dest,
                                               long val,
                                               MemoryOrderRelaxed order,
                                               MemoryScopeDevice scope) {
  return Impl::atomic_oper_fetch(
...
__device__ inline long long device_atomic_sub_fetch(long long* const dest,
                                                    long long val,
                                                    MemoryOrderRelaxed order,
                                                    MemoryScopeDevice scope) {
  return Impl::atomic_oper_fetch(
...
__device__ inline long device_atomic_sub_fetch(long* const dest,
                                               long val,
                                               MemoryOrderRelaxed order,
                                               MemoryScopeDevice scope) {
  return Impl::atomic_oper_fetch(
...
__device__ inline long long device_atomic_or_fetch(long long* const dest,
                                                   long long val,
                                                   MemoryOrderRelaxed order,
                                                   MemoryScopeDevice scope) {
  return Impl::atomic_oper_fetch(
...
__device__ inline long device_atomic_or_fetch(long* const dest,
                                              long val,
                                              MemoryOrderRelaxed order,
                                              MemoryScopeDevice scope) {
  return Impl::atomic_oper_fetch(
...
__device__ inline long long device_atomic_xor_fetch(long long* const dest,
                                                    long long val,
                                                    MemoryOrderRelaxed order,
                                                    MemoryScopeDevice scope) {
  return Impl::atomic_oper_fetch(
...
__device__ inline long device_atomic_xor_fetch(long* const dest,
                                               long val,
                                               MemoryOrderRelaxed order,
                                               MemoryScopeDevice scope) {
  return Impl::atomic_oper_fetch(
...
__device__ inline long long device_atomic_and_fetch(long long* const dest,
                                                    long val,
                                                    MemoryOrderRelaxed order,
                                                    MemoryScopeDevice scope) {
  return Impl::atomic_oper_fetch(
...
__device__ inline long device_atomic_and_fetch(long* const dest,
                                               long val,
                                               MemoryOrderRelaxed order,
                                               MemoryScopeDevice scope) {
  return Impl::atomic_oper_fetch(
